...
Q7.) The qualification for being labeled as a defensively oriented team was chosen to have a penalty kill chance to goals against ratio above 1.2 or a power play goal to goals for ratio below .228. These values were chosen by sorting the created dataset after creating these ratios and analyzing the midway points for both ratios.
