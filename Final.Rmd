...
## Introduction
  The datasets used for this project were derived from the Professional Hockey Database from Kaggle (https://www.kaggle.com/open-source-sports/professional-hockey-database). This data source is a combination of 20 datasets, of which 5 were utilized (masters, coaches, awardCoaches, teams and teamsPost). Furthermore,
