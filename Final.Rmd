...
**answer**   
We are looking at the teams that had a coach win the Jack Adams during the 5 year period from 1995 to 2000, and how well that team did for the following five years. It appears that no general trend is consistently present for these teams so we are unable to conclude anything about tea performance after a coach wins the Jack Adams.   
```{r, warning=FALSE}
...
**answer**  
Al Arbour has the record for coaching the same NHL team for the longest number of years (New York Islanders for 20 years), followed by Art Ross with the Boston Bruins for 16 years.   
```{r}
